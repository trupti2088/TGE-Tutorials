...
MyGame = function()
{
    ...
    var gameImages = [ 
    	...
    	{id:'paddle', url:'paddle.png'}, 
    	{id:'ball', url:'ball.png'},
        {id:'screen_fade',url:'ui/images/fade.png'},
        {id:'mainmenu_play_button', url:'ui/images/mainmenu/play_button.png'},
        {id:'pausescreen_resume_button', url:'ui/images/pausescreen/resume_button.png'},
        {id:'gameover_tryagain_button', url:'ui/images/gameover/tryagain_button.png'},
        {id:'gameover_twitter_share', url:'ui/images/gameover/twitter_share.png'},
        {id:'gameover_twitter_follow', url:'ui/images/gameover/twitter_follow.png'} ];
...
MyGame.prototype =
{
    ...
    subclassStartPlaying: function()
    {
        ...
        this.mBestScoreText = this.CreateWorldEntity(TGE.Text).Setup( this.Width()/2, this.Height()*0.955, "Best Score: " + this.mBestScore, "bold 22px Arial", "center", "middle", "#454");
